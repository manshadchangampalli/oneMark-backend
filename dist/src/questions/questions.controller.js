...
let QuestionsController = class QuestionsController {
    ...
    findMany(req, examId, subjectId, topicId, difficulty, limit = '20', cursor) {
        const user = req.user;
        return this.questionsService.findMany(user.id, examId, subjectId, topicId, difficulty, parseInt(limit, 10), cursor);
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], QuestionsController.prototype, "findMany", null);
